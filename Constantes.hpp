...
string const MSSG_ERR_NOMBRE_DENT_MINIMUM = MSSG_ERR_NOMBRE_DENT_MINIMUM_P1 + to_string(NOMBRE_DENT_MINIMUM) + MSSG_ERR_NOMBRE_DENT_MINIMUM_P2;
...
string const MSSG_ERR_NOMBRE_SILLON = MSSG_ERR_NOMBRE_SILLON_P1 + to_string(NOMBRE_SILLON_MINIMUM) +
MSSG_ERR_NOMBRE_SILLON_P2 + to_string(NOMBRE_SILLON_MAXIMUM) +
